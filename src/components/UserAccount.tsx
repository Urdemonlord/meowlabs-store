    ...
    <div className="min-h-screen bg-gray-900 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Kelola profil dan riwayat pembelian Anda</p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      value={user.name}
                      className="w-full px-4 py-3 border border-gray-600 rounded-xl bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                      readOnly
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">Bergabung Sejak</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">Status Akun</label>
                ...
                <div className="bg-gradient-to-b from-gray-800/50 to-gray-900/50 rounded-2xl p-8 border border-gray-700/50">
                  ...
                  {purchaseHistory.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 mb-6">Mulai berbelanja untuk melihat riwayat pembelian Anda</p>
                      <button
                    ...
                    <div className="space-y-4">
                      {purchaseHistory.map(purchase => (
                        <div key={purchase.id} className="border border-gray-700 rounded-xl p-6">
              ...
              <div className="bg-gradient-to-b from-gray-800/50 to-gray-900/50 rounded-2xl p-8 border border-gray-700/50">
                ...
                {purchaseHistory.filter(p => p.downloadLinks && p.downloadLinks.length > 0).length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-400">Beli produk digital untuk mengakses download</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {purchaseHistory
                      ...
                      .map(purchase => (
                        purchase.downloadLinks?.map(download => {
                          ...
                          return (
                            <div key={download.productId} className="border border-gray-700 rounded-xl p-6">
